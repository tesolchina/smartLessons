...
A summary of the differences in frequency of each type of strategic hedge in the RAs and theses is shown in Table 9.

# 4. Personal and impersonal expression of hedges

The quantification of personally attributed hedges in the RAs and theses indicates that even though hedges are expressed mostly impersonally in RAs, RA authors do employ some personal attribution when hedging, while students virtually totally refrain from doing so. Only $0 . 6 \%$ of all hedges in the theses were personally attributed, as opposed to $16 \%$ in the RAs (see Table 10), and were all expressed with collective pronouns (we, our). Preference for collective pronouns over $I _ { - }$ or my is a characteristic of the hard sciences, where research is usually carried out in laboratories by teams of researchers, and where joint publication is the norm (Hyland, 2001b).

As mentioned earlier, the motivation behind the use of personal attribution when hedging propositions has been attributed to a reader orientation, and a desire on the part of the writers to mark their claims as personal beliefs, hedge their assertiveness and open up avenues for dialogue with the readers (Hyland, 1996). Taking responsibility for a claim and not presenting it as directly deriving from hard data softens it, hedges its generalisability, and marks it as an individual interpretation, open to alternative judgements (Hyland, 1996, 2000; Myers, 1989):

Table 9 Types of strategic hedges in the RAs and theses   

<html><body><table><tr><td>Types of strategic hedges</td><td>RAs percentages</td><td>Theses percentages</td></tr><tr><td>Limitations of scope of paper/thesis</td><td>25</td><td>2</td></tr><tr><td>Limitations of study (testability)</td><td>10</td><td>19</td></tr><tr><td>Limitations of method</td><td>40</td><td>27</td></tr><tr><td>Limited knowledge</td><td>12.5</td><td>3</td></tr><tr><td>Agreement with other research.</td><td>12.5</td><td>49</td></tr><tr><td>Total</td><td>100</td><td>100</td></tr></table></body></html>

23. We approach this problem in the belief that . (Deane et al., 1996-RA)   
24. We feel that our results may serve as a good guide . (Robertson et al., 1998-RA)

Personally attributed hedges can also make a personal reference to limitations of the method, or admit to personal lack of knowledge and again hedge author assertiveness:
