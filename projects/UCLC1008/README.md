...
Auto-generated index for project `UCLC1008` at 2025-09-12T07:04:39Z UTC.
...
5. Ad-hoc PYTHONPATH (no install):
   ````bash
   PYTHONPATH=/Users/simonwang/Documents/Usage/VibeCoding/DailyAssistant python /Users/simonwang/Documents/Usage/VibeCoding/DailyAssistant/tools/cli/generate_project_indexes.py --dirs UCLC1008
   ````
