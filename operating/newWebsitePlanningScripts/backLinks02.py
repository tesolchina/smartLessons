...
def update_notes_with_backlinks(folder_path, backlinks):
    ...
    try:
        ...
        # Check if backlink information already exists
        if any("no. of backlinks:" in line for line in notes_content):
            print(f"[INFO] Backlink information already exists in {notes_path}, skipping...")
            return
...
def process_organised_folders(base_dir):
    """
    Process each folder in existingWebpages to find backlinks and update notes.md.
    """
...
if __name__ == "__main__":
    # Process folders in existingWebpages to find backlinks and update notes.md
    process_organised_folders(BASE_DIR)